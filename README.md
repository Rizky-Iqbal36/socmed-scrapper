...
<p align="center">Socmed scrapper is a project dedicated to scrap datas from some socmed platform such as instagram, twitter, etc. to be able to do this, this project is weaponized by <a href="https://www.selenium.dev/" target="_blank">Selenium</a> and (may be) some third party </p>
